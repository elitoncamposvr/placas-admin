...
<form method="post">
    <div class="table-line mb-4">
        <div class="w-1/2 pr-1">
            ...
            <input type="email" name="email" id="email" class="w-full" disabled value="<?php echo $user_info['email']; ?>">
        </div>
        <div class="w-1/2">
    ...
    <div class="table-line justify-center">
        <button class="btn" type="submit"><i class="fas fa-edit"></i> Editar Usuário</button>
    </div>
</form>